...
<table > 
   ...
   <div className="alignleft">
       <Card>
        ...
        className="mb-3" >
            <Form.Control className="spacer" type="text" name="managerComments" defaultChecked="null"  onChange={(e)=>this.handleChange({managerComment:e.target.value})}></Form.Control>
        </FloatingLabel>  
      <Row className="g-3">
